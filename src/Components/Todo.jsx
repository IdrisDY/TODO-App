...
console.log(todo)
  return (
    <>
    <div ref={innerRef} className = 'todo-main' style={todo.filterClicked ==='complete'&& !todo.complete || todo.filterClicked ==='active'&& todo.complete?{display:'none'}:{display:'flex'}} draggable='true'>
